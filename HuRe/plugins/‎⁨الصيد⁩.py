...
from zthon import from HuRe import l313l
...
ZelzalChecler_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 Tip𝗧𝗵𝗼𝗻 - اوامـر الصيـد والتشيكـر](t.me/e9n99) 𓆪\n\n"
        ...
        if isav == True:
            try:
                ...
                await event.client.send_message(
                    event.chat_id,
                    "ᯓ Tip𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - صيـد تيبثــون 💡\n**•────────────────────•**\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Channel ❳\n**•────────────────────•**\n- By ❲ @e9n99 ❳ ".format(
                        username, trys, choice
                    ),
                )
                await event.client.send_message(
                    ch,
                    "ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - صيـد تيبثــون 💡\n**•────────────────────•**\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Channel ❳\n**•────────────────────•**\n- By ❲ @e9n99 ❳ ".format(
                        username, trys, choice
                    ),
                )
                await event.client.send_message(
...
@from HuRe import l313l.zed_cmd(pattern="تثبيت (.*)")
async def _(event):
...
@from HuRe import l313l.zed_cmd(pattern="حالة الصيد")
async def _(event):
    if "on" in isclaim:
...
@from HuRe import l313l.zed_cmd(pattern="حالة التثبيت")
async def _(event):
    if "on" in isauto:
...
@from HuRe import l313l.zed_cmd(pattern="حاله الصيد")
async def _(event):
    if "on" in isclaim:
        await event.edit(f"**- الصيد وصل لـ({trys[0]}) من المحـاولات**")
    elif "off" in isclaim:
...
@from HuRe import l313l.zed_cmd(pattern="حاله التثبيت")
async def _(event):
    if "on" in isauto:
        await event.edit(f"**- التثبيت وصل لـ({trys2[0]}) من المحاولات**")
    elif "off" in isauto:
...
@from HuRe import l313l.zed_cmd(pattern="ايقاف الصيد")
async def _(event):
    if "on" in isclaim:
        isclaim.clear()
        isclaim.append("off")
...
@from HuRe import l313l.zed_cmd(pattern="ايقاف التثبيت")
async def _(event):
    if "on" in isauto:
        isauto.clear()
        isauto.append("off")
